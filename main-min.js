...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function handleMobileMenu(link, activePage) {
        ...
        value: function render() {
            return React.createElement(
                "div",
                null,
                React.createElement(Header, { toggleMobileMenu: this.toggleMobileMenu }),
...
var BasicLink = function (_React$Component2) {
    _inherits(BasicLink, _React$Component2);

    function BasicLink(props) {
        _classCallCheck(this, BasicLink);

        var _this3 = _possibleConstructorReturn(this, (BasicLink.__proto__ || Object.getPrototypeOf(BasicLink)).call(this, props));
...
var About = function (_React$Component3) {
    ...
    function About(props) {
        ...
        var _this4 = _possibleConstructorReturn(this, (About.__proto__ || Object.getPrototypeOf(About)).call(this, props));
...
var ImageSlideshow = function (_React$Component4) {
    _inherits(ImageSlideshow, _React$Component4);

    function ImageSlideshow(props) {
        _classCallCheck(this, ImageSlideshow);

        var _this5 = _possibleConstructorReturn(this, (ImageSlideshow.__proto__ || Object.getPrototypeOf(ImageSlideshow)).call(this, props));

        _this5.switchImage = _this5.switchImage.bind(_this5);
        _this5.state = {
            activeImage: 0
        };
        return _this5;
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    images.map(function (image, index) {
                        return React.createElement(Dot, { key: image.link + '-dot', number: index, active: index === _this6.state.activeImage ? true : false, handleClick: _this6.switchImage });
                    })
                )
            );
        }
...
var RightBuffer = function (_React$Component5) {
    _inherits(RightBuffer, _React$Component5);
...
var Dot = function (_React$Component6) {
    _inherits(Dot, _React$Component6);

    function Dot(props) {
        _classCallCheck(this, Dot);

        var _this8 = _possibleConstructorReturn(this, (Dot.__proto__ || Object.getPrototypeOf(Dot)).call(this, props));

        _this8.handleClick = _this8.handleClick.bind(_this8);
        _this8.state = {
            number: _this8.props.number
        };
        return _this8;
    }
...
var Project = function (_React$Component7) {
    _inherits(Project, _React$Component7);

    function Project(props) {
        _classCallCheck(this, Project);

        var _this9 = _possibleConstructorReturn(this, (Project.__proto__ || Object.getPrototypeOf(Project)).call(this, props));

        _this9.props.registerLink(_this9.props.link, _this9);
        _this9.handleClick = _this9.handleClick.bind(_this9);
        _this9.state = {
            href: _this9.props.link,
            active: false
        };
        return _this9;
    }
